...
void Autoencoder::free_memory() {
    delete[] w1; delete[] b1; delete[] dw1; delete[] db1;
    delete[] w2; delete[] b2; delete[] dw2; delete[] db2;
    delete[] w3; delete[] b3; delete[] dw3; delete[] db3;
    delete[] w4; delete[] b4; delete[] dw4; delete[] db4;
    delete[] w5; delete[] b5; delete[] dw5; delete[] db5;
    delete[] act1; delete[] act2; delete[] act3; delete[] act4; delete[] act5;
    delete[] pool1; delete[] conv3_out; delete[] up1; delete[] up2;
}
...
void Autoencoder::backward(const float* input, const float* target, int batch_size) {
    ...
    conv2d_backward(up2, w5, dL_dact5, dL_dup2, dw5, db5,
    ...
    conv2d_backward(up1, w4, dL_dact4, dL_dup1, dw4, db4,
    ...
    conv2d_backward(act3, w3, dL_dconv3, dL_dact3, dw3, db3,
                    batch_size, 128, 128, 8, 8);
    
    // 9. Backward through MaxPool2: 16x16->8x8
    maxpool2d_backward(act2, act3, dL_dact3, dL_dact2,
    ...
    conv2d_backward(pool1, w2, dL_dact2, dL_dpool1, dw2, db2,
                    batch_size, 256, 128, 16, 16);
    
    // 12. Backward through MaxPool1: 32x32->16x16
    maxpool2d_backward(act1, pool1, dL_dpool1, dL_dact1,
    ...
    conv2d_backward(input, w1, dL_dact1, dL_dinput, dw1, db1,
